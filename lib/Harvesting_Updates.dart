...
*/
  ...
  String? _selectedHarvest = 'Select Method';
...
//  List<String> _manPowerName = ['Select Man Power'];
  ...
  final List<String> _yieldName = [
    'Select Yield', 'Yield 1', 'Yield 2', 'Yield 3'
  ];


  final List<String> _purposeName = [
    'Select Purpose', 'Supply', 'Silage Making', 'Hay Making'
  ];

  final List<String> _HarvestName = [
    'Select Method', 'Manual', 'Machine', 'Semi-Manual','Combine Harvester','Hand Tools','Mechanical Tools'
  ];
...
///////////////////////////////////////////////////////////////// old code ///////////////////////////////////////////////////
  ...
  // Update the _fetchBlocksAndPlots function to initialize the seed name dropdown
  ...
  void _updatePlots(String blockName) {
    ...
    if (selectedBlock.isNotEmpty) {
      setState(() {
        ...
        // Update seed dropdown with all unique seed names
        _seedName = ['Select Seed Name'];
  ...
  void _updateAreaText(String plotName) {
    ...
    if (plotName == 'Select Plot') {
      setState(() {
        ...
        // Keep seed dropdown populated but reset selection
        _selectedSeedName = 'Select Seed Name';
    ...
    if (matchingPlots.isNotEmpty) {
      ...
      setState(() {
        ...
        // Check if is_fodder_crop is 1 and show purpose dropdown accordingly
        _showPurposeDropdown = selectedPlot['is_fodder_crop'] == 1;
...
setState(() {
  ...
  Future<void> _submitForm() async {
    ...
    //      'category': selectedCategories.toList(), // Convert Set to List
        ...
        // Make API call
        final response = await http.post(
          Uri.parse('https://ccbfsolution.pmmsapp.com/api/harvesting'),
          headers: {
            'Authorization': 'Bearer $token',
            'Content-Type': 'application/json',
...
//////////////////////////////////////////////////////////////////////////////////////////////////
  void _resetForm() {
    ...
    /*  _selectedTractor = 'Select Tractor';
      ...
      _selectedPurpose = 'Select Purpose';
      _selectedSeedName = 'Select Seed Name';
      _selectedHarvest = 'Select Method';
