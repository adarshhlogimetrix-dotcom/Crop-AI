      ...
      children: [
        ...
        Row(
          ...
          children: [
           ...
           /* TextButton(onPressed:_addNewSparePart,
              child: Text('+ Add Spare',
                style: TextStyle
...
// Modified _selectTime method with initialTime set to current time or existing selection
  ...
  void _handleMachineSelection(String machine, bool selected, FormFieldState<Set<String>> state) {
    setState(() {
      if (selected == true) {
  ...
  void _handleTractorSelection(String tractor,
      bool selected, FormFieldState<Set<String>> state) {
    setState(() {
      if (selected == true) {
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return CheckboxListTile(
                      ...
                      onChanged: (bool? selected) {
                        _handleMachineSelection(machine, selected ?? false, state);
                        setState(() {
                          if (selected == true) {
                            selectedMachines.add(machine);
                          } else {
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return CheckboxListTile(
                      ...
                      onChanged: (bool? selected) {
                        _handleTractorSelection(tractor, selected ?? false, state);
                        setState(() {
                          if (selected == true) {
                            selectedTractors.add(tractor);
                          } else {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final Map<String, dynamic> requestData = {
          ...
          //   'user_id': 1, // This should be fetched from user authentication
        };
        ...
        // Make API call
        final response = await http.post(
          Uri.parse('https://ccbfsolution.pmmsapp.com/api/area-leveling/store'),
          headers: {
            'Authorization': 'Bearer $token',
            'Content-Type': 'application/json',
        ...
        if (response.statusCode == 200 || response.statusCode == 201) {
          ...
          // Enhanced Error handling - Parse error response (same as sowing code)
          try {
            ...
            if (errorData.containsKey('error')) {
              ...
              // Check for fuel stock error or other resource availability errors
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildCustomTextField(
                    labelText: 'Area Leveling(Acre)',
                    hintText: 'Enter Area Leveling',
